...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2107',
            //extent: [-3260586.728400, 419435.993800, 6758167.443000, 10438190.165200],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([437762.781444, 826670.901465, 437859.677526, 826734.305367], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_GeoDatabaseLiveR0_1,
    colName: 'Client.Job.Test',
    zoom: 10,
    collapsed: true,
    map: map
});
